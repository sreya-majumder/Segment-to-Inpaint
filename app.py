...
sam_checkpoint = "files/sam_vit_h_4b8939.pth"
model_type = "vit_h"
...
with gr.Blocks() as demo:
  ...
  def generate_mask(img, evt: gr.SelectData):
  ...
  submit.click(inpaint, inputs = [input_img, mask_img, prompt], outputs = [output_img])
